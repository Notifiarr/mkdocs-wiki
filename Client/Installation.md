...
description: Notifiarr Client Installation Page
published: true
date: 2024-11-28T17:15:28.963Z
tags: 
editor: markdown
dateCreated: 2021-05-22T01:08:57.387Z
---

<img src="https://notifiarr.com/images/logo/notifiarr.png">
...
> This works on any system with `apt` or `yum`. **If your system does not use APT or YUM, then download a binary from the [Releases](https://github.com/Notifiarr/notifiarr/releases) page and install it.**
{.is-warning}
...
1.	Type `cd notifiarr`
1.	On https://github.com/Notifiarr/notifiarr/releases find the latest release asset labelled notifiarr.amd64.linux.gz, right  click on that and click copy link.
1.	Back on your terminal type `wget '<paste link>'`
1.	Type `gzip -d notifiarr.*`
1.	Type `mv notifiarr.* notifiarr`
1.	Type `chmod +x notifiarr`
1.	In the notifiarr folder create notifiarr.conf from this: https://github.com/Notifiarr/notifiarr/blob/main/examples/notifiarr.conf.example
...
- [Reverse Proxy](/Client/ReverseProxy)
{.links-list}