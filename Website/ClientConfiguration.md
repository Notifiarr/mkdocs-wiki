---
title: Clients Setup
description: How to add and setup your clients on the website
published: true
date: 2023-11-12T10:52:02.986Z
tags: 
editor: markdown
...
![client-config-card.png](/clientconfig/client-config-card.png) ![client-config-list.png](/clientconfig/client-config-list.png)

When you open the client settings you will see:

![client_config_settings2.jpg](/clientconfig/client_config_settings2.jpg)
...
First thing is to add a command in the local client. Commands are basically custom scripts you want to trigger. Read below to understand how they work and then add them to the client.
 ...
 ![commands-4.png](/clientconfig/commands-4.png)
...
At the bottom of the client configuration is a `Commands` section
 ...
 ![commands-1.png](/clientconfig/commands-1.png)
 
 1. Click the `+` to expand the command settings
 
 ![commands-2.png](/clientconfig/commands-2.png)
...
![commands-3.png](/clientconfig/commands-3.png)
