...
![trigger_channels_new.png](/dashboard/trigger_channels_new.png)
...
![discord_channel_setup_new.png](/dashboard/discord_channel_setup_new.png)
...
![open_configuration_new.png](/dashboard/open_configuration_new.png)

Click the **cog icon** to open the configuration options for the Dashboard integration and the following window will open.

![integration_settings.png](/dashboard/integration_settings.png)
...
![extra_settings.png](/dashboard/extra_settings.png)
