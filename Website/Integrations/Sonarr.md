...
> In the upcoming new Sonarr v4 (currently in closed, pre-alpha testing), [Notifiarr will be a native connection](https://github.com/Sonarr/Sonarr/commit/2fb56557899d184944fc6dd05ab1fd8ddd44258e). There is no ETA for the public release of v4 and do not ask the Sonarr team when v4 will be released nor how to access it.
{.is-info}
