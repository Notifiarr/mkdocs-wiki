...
1. Triggers
    - `Started` - Sent when Better Stack detects an issue with a site you are monitoring
    - `Ack` (Acknowledged) - Sent when you mark the issue as acknowledged through Better Stack
...
Click the **cog icon** to open the configuration options for Better Stack.
...
1. Better Stack team id that is used to link the Incident in the notification
